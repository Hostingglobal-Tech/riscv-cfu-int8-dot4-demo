...
def with_zicsr(flags):
    """Append zicsr for newer GCC/binutils that split CSR instructions out."""
    return flags.replace('-march=rv32imf', '-march=rv32imf_zicsr') \
                .replace('-march=rv32im', '-march=rv32im_zicsr') \
                .replace('-march=rv32i ', '-march=rv32i_zicsr ')
...
def patch_cpu_variant():
    ...
    vexriscv_core.GCC_FLAGS.update({
        'fomu':                 with_zicsr('-march=rv32im -mabi=ilp32 -mno-div'),
        'fomu+cfu':             with_zicsr('-march=rv32im -mabi=ilp32 -mno-div'),
        'breaker':              with_zicsr('-march=rv32im -mabi=ilp32 -mno-div'),
        'breaker+cfu':          with_zicsr('-march=rv32im -mabi=ilp32 -mno-div'),
        'custom':               with_zicsr('-march=rv32im -mabi=ilp32'),
        'custom+cfu':           with_zicsr('-march=rv32im -mabi=ilp32'),
        'fpu':                  with_zicsr('-march=rv32imf -mabi=ilp32'),
        'fpu+cfu':              with_zicsr('-march=rv32imf -mabi=ilp32'),
        'hps+cfu':              with_zicsr('-march=rv32im -mabi=ilp32'),
        'hpsdelta+cfu':         with_zicsr('-march=rv32im -mabi=ilp32'),
        'dbpl8+cfu':            with_zicsr('-march=rv32im -mabi=ilp32'),
        'minimal+cfu':          with_zicsr('-march=rv32i  -mabi=ilp32'),
        'slimopt+cfu':          with_zicsr('-march=rv32im -mabi=ilp32'),
        'slim+cfu':             with_zicsr('-march=rv32im -mabi=ilp32'),
        'slim+cfu+debug':       with_zicsr('-march=rv32im -mabi=ilp32'),
        'perf+cfu':             with_zicsr('-march=rv32im -mabi=ilp32'),
        'perf+cfu+debug':       with_zicsr('-march=rv32im -mabi=ilp32'),
        'slimperf+cfu':         with_zicsr('-march=rv32im -mabi=ilp32'),
        'slimperf+cfu+debug':   with_zicsr('-march=rv32im -mabi=ilp32'),
        ...
        'full+cfu':             with_zicsr('-march=rv32im -mabi=ilp32'),
        'full+cfu+debug':       with_zicsr('-march=rv32im -mabi=ilp32'),
    })
